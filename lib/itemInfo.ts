export const itemInfo = [
  ...
  {
    imageSrc: '/assets/skills/nextjs.png',
    headingText: 'Next JS',
    mainText:
  ...
  {
    imageSrc: '/assets/skills/redux.png',
    headingText: 'Redux',
    mainText:
  ...
  {
    imageSrc: '/assets/skills/sass-logo.png',
    headingText: 'Sass',
    mainText:
  ...
  {
    imageSrc: '/assets/skills/tailwind-logo.png',
    headingText: 'Tailwind CSS',
    mainText:
  ...
  {
    imageSrc: '/assets/skills/bootstrap-logo.png',
    headingText: 'Bootstrap',
    mainText:
